...
public class Solution {
    ...
    public static void cleanAllApartments(List<Apartment> apartments) {
        ...
        for(Apartment apr : apartments){
            if(apr instanceof Apt1Room) ((Apt1Room) apr).clean1Room();
            else if(apr instanceof Apt2Room) ((Apt2Room) apr).clean2Rooms();
            else if(apr instanceof Apt3Room) ((Apt3Room) apr).clean3Rooms();
        }
    }
